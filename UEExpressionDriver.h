...
typedef enum UnifiedExpressions
{
...
struct UEExpressionShape
{
    float weight;
};

void foo(UEExpressionShape bar[]) {
    auto ff = bar[UnifiedExpressions::SoftPalateClose];
}

class UEExpressionDriver
{
};